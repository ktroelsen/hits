            ...
            <form onSubmit={handleSubmit} className="mt-5 text-left">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 min-w-0 px-4 py-3 rounded-2xl bg-slate-950/60 border border-amber-500/40 text-white font-bold focus:outline-none focus:border-amber-400"
                />
                <button
                  type="submit"
                  disabled={!name.trim() || status === 'saving'}
                  className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-amber-500 hover:bg-amber-400 disabled:opacity-50 text-slate-950 font-bold text-sm transition-colors"
                >

...
export function RulesModal({ isOpen, onClose }: RulesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-charcoal-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl bg-charcoal-900 border border-charcoal-800 rounded-3xl p-6 sm:p-7 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        {/* Glow accent */}
        <div className="absolute top-0 right-0 w-48 h-48 bg-coral-500/10 rounded-full blur-3xl pointer-events-none" />

        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-charcoal-800">
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-xl bg-coral-500/20 text-coral-400 border border-coral-500/30">
        ...
        <div className="mt-5 space-y-4">
          <div className="flex gap-3.5 p-3.5 rounded-2xl bg-charcoal-950/50 border border-charcoal-800/80">
            <div className="w-8 h-8 rounded-xl bg-coral-500/20 text-coral-400 border border-coral-500/30 flex items-center justify-center shrink-0 font-black text-sm">
              1
            </div>
            <div>
              <h4 className="text-sm font-bold text-charcoal-200 flex items-center gap-1.5">
                <Music className="w-4 h-4 text-coral-400" />
                Lyt til sangen
              </h4>
          ...
          <div className="flex gap-3.5 p-3.5 rounded-2xl bg-charcoal-950/50 border border-charcoal-800/80">
            <div className="w-8 h-8 rounded-xl bg-lemon-500/20 text-lemon-400 border border-lemon-500/30 flex items-center justify-center shrink-0 font-black text-sm">
              2
            </div>
            <div>
              <h4 className="text-sm font-bold text-charcoal-200 flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-lemon-400" />
          ...
          <div className="flex gap-3.5 p-3.5 rounded-2xl bg-charcoal-950/50 border border-charcoal-800/80">
            <div className="w-8 h-8 rounded-xl bg-mint-500/20 text-mint-400 border border-mint-500/30 flex items-center justify-center shrink-0 font-black text-sm">
              5
            </div>
            <div>
              <h4 className="text-sm font-bold text-charcoal-200 flex items-center gap-1.5">
        ...
        {/* Footer */}
        <div className="mt-6 pt-4 border-t border-charcoal-800 flex justify-end">
          <button
            onClick={onClose}
            className="px-5 py-2.5 rounded-xl bg-lemon-400 hover:bg-lemon-300 text-charcoal-950 font-bold text-xs tracking-wider uppercase transition-all shadow-md"
          >
